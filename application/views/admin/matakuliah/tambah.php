			...
			<div class="row">
				<div class="col-12">
					...
					<div class="card">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form action="<?php echo base_url()?>Admin_Matakuliah/tambah_aksi" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="inputEmail3"
											placeholder="Kode Matakuliah" required name="kode_matakuliah">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="inputEmail3"
											placeholder="Matakuliah" name="matakuliah">
									</div>
								</div>
