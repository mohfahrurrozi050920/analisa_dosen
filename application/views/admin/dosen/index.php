		...
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					...
					<br>
					<a href="<?= base_url() ?>Admin_Dosen/tambah" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
				</div><!-- /.col -->
				<div class="col-sm-6">
								...
								<table id="example" class="display nowrap" style="width:100%">
									...
									<?php
										...
										<tr>
											...
											<td><?= $u->username ?></td>
											<td>
												<a href="<?= base_url() ?>Admin_Dosen/edit/<?= $u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
												<a href="<?= base_url() ?>Admin_Dosen/hapus/<?= $u->id ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
											</td>
