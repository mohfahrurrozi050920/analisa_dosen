			...
			<div class="row">
				<div class="col-12">
					...
					<div class="card">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<form action="<?php echo base_url()?>Admin_Dosen/tambah_aksi" method="post">
								<div class="form-group row">
									<label for="inputEmail3" class="col-sm-2 col-form-label">NIP</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="inputEmail3" placeholder="nip"
											name="nip">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" required id="inputEmail3"
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<textarea name="alamat" required class="form-control" id="" cols="30"
											rows="5"></textarea>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-10">
										<input type="text" required class="form-control" id="inputEmail3" placeholder="Username"
											name="username">
									</div>
								</div>
